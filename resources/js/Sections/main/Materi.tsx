    ...
    <div className="relative flex flex-col items-center mt-20 px-4">
      ...
      <div className="flex flex-wrap justify-center gap-8 w-full max-w-6xl mt-8 ">
        {filteredMateri.map((major) => (
          ...
          >
            <motion.div
  className="relative bg-white rounded-2xl p-6 shadow-lg  overflow-hidden z-0 border border-gray-200"
...
>
  ...
  {/* Konten Utama */}
 <div className="relative z-10 flex flex-col items-start text-left pb-20">
  {/* Wrapper gambar + label kelas */}
  ...
  {/* Konten lainnya tanpa padding tambahan */}
 ...
 {hoveredCard === major.id && (
  <motion.div
    ...
    style={{ transition: "none" }} // Hapus semua transisi
  >
