const Footer = () => {
    ...
    return (
        <footer className="w-full bg-[#0B2441] border-t border-gray-200 py-12 mt-20">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-white">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a
                                    href="#"
                                    className="hover:text-blue-600 text-sm transition"
                                >
                                    Beranda
                                </a>
                            </li>
                    ...
                    <div className="md:col-span-1">
                        ...
                        {/* Logo Placeholder */}
                        <div className="mt-8 w-24 h-10 flex items-center justify-center text-xs">
